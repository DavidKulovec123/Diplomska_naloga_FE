...
const ColendarCard = ({examData}:{examData:any}) => {
        ...
        <>
            <div className={"container"}>
                ...
                <div className="card shadow-lg">
                        ...
                        <div className="card-body">
                            <button onClick={() => navigate(`../exams/delete/${examData.id}`) } type="button" className="btn btn-white shadow-lg" data-dismiss="modal">DELETE</button>|
                            <button onClick={() => navigate(`../editTask/${examData.id}`) } type="button" className="btn btn-white shadow-lg" data-dismiss="modal">EDIT</button>
